...
-- Create a more robust lottery tickets function that handles both scenarios:
-- 1. When order status changes to delivered (and customer_id is already set)
-- 2. When customer_id is set/updated on a delivered order (for first-time customers)
